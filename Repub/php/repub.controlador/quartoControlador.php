...
class QuartoControlador {
    ...
    public function get($id) {
        ...
        if (count($obj) > 0) {
            $quarto = new Quarto($obj[0]->id, $obj[0]->valor, $obj[0]->descricao,  $obj[0]->alugado);
        }
    ...
    public function create($quarto) {
        ...
        $sql = "INSERT INTO a14017.quartos (valor, descricao, alugado) " .
                "VALUES (:param1, :param2, :param3)";
        $params = array($quarto->valor, $quarto->descricao, $quarto->alugado);
